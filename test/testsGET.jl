...
open("data/expansion_and_dismantling.txt", "w") do f
    write(f, GETconstructor.query_expansion_and_dismantling("10YHU-MAVIR----U", "10YRO-TEL------P", DateTime(2020,12,31,23,00), DateTime(2021,12,31,23,00), "B01"))
end 
# example in API documentation gives wrong results

open("data/redispatching.txt", "w") do f
    write(f, GETconstructor.query_redispatching("NL", "BE", DateTime(2016,12,30,23,00), DateTime(2017,12,30,23,00), "A46"))
end 
# example in API documentation gives wrong results

open("data/countertrading.txt", "w") do f
    write(f, GETconstructor.query_countertrading("ES", "FR", DateTime(2015,12,31,23,00), DateTime(2016,12,31,23,00)))
end 
# example in API documentation gives wrong results

open("data/congestion_costs.txt", "w") do f
    write(f, GETconstructor.query_congestion_costs("10YDE-VE-------2", DateTime(2015,12,31,23,00), DateTime(2016,12,31,23,00), "B03"))
end 
# example in API documentation gives wrong results
...
open("data/day_ahead_generation_forecasts_wind_solar.txt", "w") do f
    write(f, GETconstructor.query_day_ahead_generation_forecasts_wind_solar("BE", DateTime(2015,12,31,23,00), DateTime(2016,12,31,23,00)))
end 

open("data/current_generation_forecasts_wind_solar.txt", "w") do f
    write(f, GETconstructor.query_current_generation_forecasts_wind_solar("BE", DateTime(2020,12,31,23,00), DateTime(2021,12,31,23,00)))
end 
# example in API documentation gives wrong results
open("data/intraday_generation_forecasts_wind_solar.txt", "w") do f
    write(f, GETconstructor.query_intraday_generation_forecasts_wind_solar("CZ", DateTime(2015,12,31,23,00), DateTime(2016,12,31,23,00)))
end 
# example in API documentation gives wrong results
...
open("data/aggregated_generation_per_type.txt", "w") do f
    write(f, GETconstructor.query_aggregated_generation_per_type("10YCZ-CEPS-----N", DateTime(2015,12,31,23,00), DateTime(2016,01,01,23,00)))
end 
=#
open("data/aggregated_filling_rate.txt", "w") do f
    write(f, GETconstructor.query_aggregated_filling_rate("FR", DateTime(2020,12,31,23,00), DateTime(2021,12,31,23,00)))
end 
# example in API documentation gives wrong results
#=
#=
